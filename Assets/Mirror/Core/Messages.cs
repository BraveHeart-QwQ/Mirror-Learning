...
public struct SpawnMessage : NetworkMessage
{
    ...
    public bool isOwner {
        ...
        set => spawnFlags = value ? spawnFlags | SpawnFlags.isOwner : spawnFlags & ~SpawnFlags.isOwner;
    }

    // Backwards compatibility after implementing spawnFlags
    public bool isLocalPlayer {
        get => spawnFlags.HasFlag(SpawnFlags.isLocalPlayer);
        set => spawnFlags = value ? spawnFlags | SpawnFlags.isLocalPlayer : spawnFlags & ~SpawnFlags.isLocalPlayer;
    }
}
