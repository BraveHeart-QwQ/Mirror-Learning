...
public static class NetworkLoop
{
    ...
    internal static int
    FindPlayerLoopEntryIndex(PlayerLoopSystem.UpdateFunction function, PlayerLoopSystem playerLoop, Type playerLoopSystemType) {
    ...
    internal static bool AddToPlayerLoop(
        ...
        if (playerLoop.type == playerLoopSystemType) {
            ...
            PlayerLoopSystem system = new PlayerLoopSystem { type = ownerType, updateDelegate = function };
